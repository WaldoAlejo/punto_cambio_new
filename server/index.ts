...
import cuadreCajaConteoRoutes from "./routes/cuadre-caja-conteo.js";
...
app.use(
  cors({
    origin: [
      ...
      "http://localhost:3001",
      "http://localhost:8080",
      "http://104.196.109.37:3001", // IP pública puerto 3001 (producción)
      "http://104.196.109.37:8080", // IP pública frontend puerto 8080
      "http://104.196.109.37", // IP pública frontend puerto 80
    ],
    credentials: true,
...
app.use("/api/cuadre-caja", cuadreCajaConteoRoutes);
