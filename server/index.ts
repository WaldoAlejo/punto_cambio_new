...
app.use(
  cors({
    origin: [
      ...
      "http://localhost:3001",
      "http://localhost:8080",
      "http://35.185.49.39:3001", // IP pública puerto 3001 (producción)
      "http://35.185.49.39:8080", // IP pública frontend puerto 8080
      "http://35.185.49.39", // IP pública frontend puerto 80
    ],
    credentials: true,
