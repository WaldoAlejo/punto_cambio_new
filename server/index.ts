...
import metalPurchaseRoutes from "./routes/metal-purchases.js";
...
app.use(
  cors({
    origin: [
      ...
      "http://localhost:3001",
      "http://localhost:8080",
      "http://35.196.160.252:3001",
      "http://35.196.160.252:8080",
      "http://35.196.160.252",
...
app.use("/api/metal-purchases", metalPurchaseRoutes);
