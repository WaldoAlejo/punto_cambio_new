...
export const transferController = {
  async createTransfer(req: AuthenticatedRequest, res: express.Response): Promise<void> {
    try {
      ...
      const newTransfer = await transferCreationService.createTransfer(transferData);
  ...
  async getAllTransfers(req: express.Request, res: express.Response): Promise<void> {
    try {
      res.set({
