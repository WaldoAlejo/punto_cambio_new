...
router.get(
  ...
  async (req: express.Request, res: express.Response) => {
    ...
    try {
      ...
      // ─────────────────────────────────────────────────────────────────────
      // 1. Obtener Cambios de Divisa (filtrado por fecha/punto si se envía)
      // ─────────────────────────────────────────────────────────────────────
      ...
      // ─────────────────────────────────────────────────────────────────────
      // 2. Obtener Asignaciones de Saldo (filtrado por fecha/punto si se envía)
      // ─────────────────────────────────────────────────────────────────────
      ...
      const fileName = `reporte_cambios_divisa_historico${rango}.xlsx`;
