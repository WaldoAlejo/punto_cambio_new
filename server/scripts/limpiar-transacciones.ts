...
async function limpiarTransacciones() {
  ...
  try {
    ...
    const detalleServicio =
      await prisma.servicioExternoDetalleCierre.deleteMany({});
    ...
    const historialAsignaciones =
      await prisma.historialAsignacionPunto.deleteMany({});
    ...
    const historialServientrega =
      await prisma.servientregaHistorialSaldo.deleteMany({});
    ...
    const solicitudesServientrega =
      await prisma.servientregaSolicitudSaldo.deleteMany({});
    ...
    const asignacionesServicio =
      await prisma.servicioExternoAsignacion.deleteMany({});
    ...
    console.log(
      `   Movimientos de saldo:            ${movimientosSaldo.count}`
    );
    ...
    console.log(
      `   Historial asignaciones:          ${historialAsignaciones.count}`
    );
    ...
    console.log(
      `   Saldos Servientrega:             ${saldosServientrega.count}`
    );
    console.log(
      `   Historial Servientrega:          ${historialServientrega.count}`
    );
    console.log(
      `   Solicitudes Servientrega:        ${solicitudesServientrega.count}`
    );
    console.log(`   Anulaciones Servientrega:        ${anulaciones.count}`);
    console.log(
      `   Movimientos servicios externos:  ${movimientosServicio.count}`
    );
    console.log(`   Saldos servicios externos:       ${saldosServicio.count}`);
    console.log(
      `   Asignaciones servicios externos: ${asignacionesServicio.count}`
    );
    console.log("   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
