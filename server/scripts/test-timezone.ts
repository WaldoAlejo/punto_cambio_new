...
console.log(
  `Esperado:      03/10/2025 18:00 (23:00 UTC - 5 horas = 18:00 Ecuador)`
);
console.log();
...
console.log(
  `Esperado:              2025-10-03T23:00:00.000Z (18:00 + 5 horas = 23:00 UTC)`
);
console.log();
...
console.log(
  `Esperado Inicio:      03/10/2025 00:00 (Ecuador) = 2025-10-03T05:00:00.000Z (UTC)`
);
console.log(
  `Esperado Fin:         04/10/2025 00:00 (Ecuador) = 2025-10-04T05:00:00.000Z (UTC)`
);
console.log();
...
console.log(
  `¿Son iguales?         ${
    original.getTime() === backToOriginal.getTime() ? "✅ SÍ" : "❌ NO"
  }`
);
console.log();
...
console.log();
console.log(
  "📚 Documentación completa en: server/scripts/MANEJO_FECHAS_ECUADOR.md"
);
console.log();
