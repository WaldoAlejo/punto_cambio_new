...
# Script para verificar el estado del servidor simple
...
curl -s http://localhost:3001/health || {
  log_error "La aplicación no está respondiendo en el puerto 3001"
  
  # Verificar si la aplicación está respondiendo en el puerto 8080
  log_message "Verificando si la aplicación está respondiendo en el puerto 8080..."
