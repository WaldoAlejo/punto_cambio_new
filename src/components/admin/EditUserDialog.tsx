...
const EditUserDialog = ({ user, isOpen, onClose, onUserUpdated, currentUser }: EditUserDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { user: updatedUser, error } = await userService.updateUser(user.id, formData);
