...
async function verificarDatos() {
    ...
    try {
        ...
        const historialServientrega = await prisma.servientregaHistorialSaldo.count();
        console.log(`   Historial Servientrega:          ${historialServientrega}`);
        const solicitudesServientrega = await prisma.servientregaSolicitudSaldo.count();
        console.log(`   Solicitudes Servientrega:        ${solicitudesServientrega}`);
