    ...
    try {
        ...
        if (punto.jornadas.length === 0) {
            ...
            punto.jornadas.forEach((jornada) => {
                ...
                console.log(`👤 Usuario: ${jornada.usuario.nombre} (${jornada.usuario.rol})`);
                console.log(`🔄 Estado: ${jornada.fecha_salida ? "Cerrada" : "Abierta"}`);
        ...
        if (transaccionesHoy.length === 0) {
            ...
            transaccionesHoy.forEach((transaccion, index) => {
                ...
                console.log(`   📋 Referencia: ${transaccion.numero_referencia || "N/A"}`);
            });
        }
        ...
        if (cierrePendiente) {
            ...
            console.log(`🕐 Fecha de cierre: ${cierrePendiente.fecha_cierre || "Pendiente"}`);
        }
        else {
