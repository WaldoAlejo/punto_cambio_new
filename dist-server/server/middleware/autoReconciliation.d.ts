 ...
 */
export declare const transferAutoReconciliation: (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction
) => Promise<void>;
 ...
 */
export declare const exchangeAutoReconciliation: (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction
) => Promise<void>;
 ...
 */
export declare const balanceUpdateAutoReconciliation: (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction
) => Promise<void>;
 ...
 */
export declare const genericAutoReconciliation: (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction
) => Promise<void>;
