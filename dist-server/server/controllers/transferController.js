...
const controller = {
    async createTransfer(req, res) {
        try {
            const { origen_id, destino_id, moneda_id, monto, tipo_transferencia, descripcion, detalle_divisas, responsable_movilizacion, via = "EFECTIVO", monto_efectivo, monto_banco, } = req.body;
