...
export const loginSchema = z.object({
    ...
    password: z
        ...
        .regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&._-])[A-Za-z\d@$!%*?&._-]/, "La contraseña debe contener al menos: 1 mayúscula, 1 minúscula, 1 número y 1 símbolo (@$!%*?&._-)"),
});
...
export const createUserSchema = z.object({
    ...
    telefono: z
        ...
        .optional()
        .nullable(),
    rol: z.enum(["ADMIN", "OPERADOR", "SUPER_USUARIO", "CONCESION", "ADMINISTRATIVO"], {
        errorMap: () => ({
            message: "Rol inválido. Debe ser ADMIN, OPERADOR, SUPER_USUARIO, CONCESION o ADMINISTRATIVO",
        }),
    }),
    punto_atencion_id: z
        .string()
