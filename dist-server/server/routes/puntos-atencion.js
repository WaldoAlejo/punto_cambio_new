...
router.post("/", authenticateToken, async (req, res) => {
    try {
        const { nombre, direccion, ciudad, provincia, codigo_postal, telefono, servientrega_agencia_codigo, servientrega_agencia_nombre, es_principal, } = req.body;
...
router.put("/:id", authenticateToken, async (req, res) => {
    try {
        const { id } = req.params;
        const { nombre, direccion, ciudad, provincia, codigo_postal, telefono, servientrega_agencia_codigo, servientrega_agencia_nombre, es_principal, activo, } = req.body;
