...
router.post("/", authenticateToken, requireRole(["ADMIN", "SUPER_USUARIO"]), validate(createUserSchema), async (req, res) => {
...
router.patch("/:id/reset-password", authenticateToken, requireRole(["ADMIN", "SUPER_USUARIO"]), async (req, res) => {
